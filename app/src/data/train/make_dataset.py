...
def make_dataset(target, cols_to_remove, model_type="RandomForest"):
    """
...
def get_raw_data_from_db_local():
    """
    Función para obtener los datos originales desde sqlite3 local

    Returns:
       DataFrame. Dataset con los datos de entrada.
    """

    return database_utils.get_raw_data_from_db()
